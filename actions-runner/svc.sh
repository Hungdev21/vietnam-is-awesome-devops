...
SVC_NAME="actions.runner.Hungdev21-vietnam-is-awesome-devops.ubuntu-server.service"
SVC_NAME=${SVC_NAME// /_}
SVC_DESCRIPTION="GitHub Actions Runner (Hungdev21-vietnam-is-awesome-devops.ubuntu-server)"
